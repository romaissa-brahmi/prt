...
service = Service(executable_path=r'/snap/chromium/2821/usr/lib/chromium-browser/chromedriver')
...
os.system("echo '{}' >> /home/ubuntu/prt/PacificPalissades.txt".format(data))
